...
INPUT_DEFAULT_PROFILES = {
    ...
    gamepad:
    {
        up:    [input_binding_gamepad_axis(gp_axislv, true),  input_binding_gamepad_axis(gp_axisrv, true),  input_binding_gamepad_button(gp_padu)],
        down:  [input_binding_gamepad_axis(gp_axislv, false), input_binding_gamepad_axis(gp_axisrv, false), input_binding_gamepad_button(gp_padd)],
        left:  [input_binding_gamepad_axis(gp_axislh, true),  input_binding_gamepad_axis(gp_axisrh, true),  input_binding_gamepad_button(gp_padl)],
